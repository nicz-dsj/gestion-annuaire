 ...
 * 
 * Etudiants référents : James MOREL (auteur de la fonction)
 */
 ...
 * 
 * Etudiants référents : Nicolas DE SAINT JEAN (auteur de la fonction) & James MOREL
 */
        ...
        if (mode>0)
        {
          do{
            ...
            if (pos_valeur>0)
            {
                ...
                *fin=encadrement_sup(valeur,client,tab_ind_filtre,*fin,pos_valeur,mode);
                fin_temps = clock();
                temps_total = temps_total + (fin_temps - debut_temps);
                affichage(client,tab_ind_filtre,*deb,*fin,(*fin)-(*deb),1); // affiche le résultat du filtre
            }
            else{
                printf(" ---------------------------------------------------------------------------\n");
